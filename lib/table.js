'use strict';
const { QueryCommand, ScanCommand, BatchGetItemCommand, CreateTableCommand, DescribeTableCommand, DeleteTableCommand, UpdateTableCommand } = require("@aws-sdk/client-dynamodb");
